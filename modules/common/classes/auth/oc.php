<?php 
/**
 * Extended functionality for Auth module, driver
 *
 * @package    OC
 * @category   Auth
...
class Auth_OC extends Kohana_Auth {
	 ...
	 * @deprecated check roles maybe redirect to an specific home if exists?
	 */
	public function login_redirect()
	{
		/*if (Auth::instance()->get_user()->role ==  Model_User::ROLE_ADMIN)
		{*/
			Request::current()->redirect(Route::url('default',array('controller'=>'home','action'=>'index')));
		//}
		 
		//not in use
		//Request::current()->redirect(Route::url('default',array('controller'=>'profile','action'=>'index')));
	}
