...
class Auth_Crud extends Auth_Controller
{
	...
	/**
	 * @var $_route_name Route to be used for actions (default: user, check /common/config/routes.php)
	 */
	protected $_route_name = 'default';
	...
	function __construct(Request $request, Response $response)
	{
		...
		{
			$url = Route::get('default')->uri(array('controller'  => $this->request->controller(), 
												'action'      => 'index'));
		...
		$url_bread = Route::url('default',array('controller'  => $this->request->controller()));
	...
	public function action_index($view = NULL)
	{
		...
		$this->template->scripts['footer'][] = 'js/crud/index.js';
	...
	public function action_create()
	{
		...
		return $this->render('pages/crud/create', array('form' => $form));
	}
	...
	public function action_update()
	{
		...
		return $this->render('pages/crud/update', array('form' => $form));
	}
